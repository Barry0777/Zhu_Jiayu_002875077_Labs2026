...
public class MainJFrame extends javax.swing.JFrame {
    ...
    private void setLoginScreen() {
         LoginScreen loginPanel = new LoginScreen(mainWorkArea, supplierDirectory);

    
    CardLayout cardManager = (CardLayout) mainWorkArea.getLayout();
    mainWorkArea.add("LoginPanelCard", loginPanel);

    
    cardManager.show(mainWorkArea, "LoginPanelCard");
