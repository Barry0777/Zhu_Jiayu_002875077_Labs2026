...
public class ViewProductDetailJPanel extends javax.swing.JPanel {
    ...
    // 刷新并提示
    refreshTable();
    JOptionPane.showMessageDialog(this, "Product details have been updated successfully!");
        
    }//GEN-LAST:event_btnSaveActionPerformed
    private void setEditableState(boolean editable) {
    txtName.setEditable(editable);
    txtPrice.setEditable(editable);
    tblFeatures.setEnabled(editable);
    btnAddFeature.setEnabled(editable);
    btnRemoveFeature.setEnabled(editable);
