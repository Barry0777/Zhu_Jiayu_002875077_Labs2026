...
// person representing sales organization        
        ...
        Person person010 = persondirectory.newPerson("Dr. Emily Clark");
...
// Create User accounts that link to specific profiles
        ...
        FacultyProfile fp = facultydirectory.createFacultyProfile(person010);
        UserAccount ua5 = uadirectory.newUserAccount(fp, "faculty1", "****");
        return business;
